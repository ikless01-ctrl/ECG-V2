...
// v9: expand every previously short atlas chapter and begin study-image annotations.
Object.assign(STUDY_TOPICS.find(t=>t.title==='Heart axis'), {
  summary:'Learn the frontal QRS axis as four polarity patterns, then refine borderline cases with lead II.',
  points:['Lead I positive + aVF positive: normal quadrant','Lead I positive + aVF negative: leftward quadrant','Lead I negative + aVF positive: rightward quadrant','Lead I negative + aVF negative: extreme quadrant','Use lead II to distinguish borderline normal from true left-axis deviation'],
  examples:[
    {title:'Normal frontal QRS axis',image:'assets/ecgs/119_Normal ECG.jpg',caption:'Predominantly positive QRS complexes in both lead I and aVF place the axis in the normal quadrant, approximately −30° to +90°.',features:['Lead I predominantly positive','aVF predominantly positive','Lead II usually positive','Axis roughly −30° to +90°'],pearl:'Positive-positive = normal quadrant.',annotations:[{x:1,y:4,w:32,h:90,label:'Compare lead I with aVF',tone:'green'}]},
    {title:'Left-axis deviation pattern',image:'assets/ecgs/left ventricular hypertrophy1.jpeg',caption:'A positive QRS in lead I with a negative QRS in aVF suggests a leftward axis; lead II helps confirm true deviation beyond −30°.',features:['Lead I positive','aVF negative','Lead II negative supports axis < −30°','Consider LAFB, LVH or inferior infarction'],pearl:'I positive, aVF negative—then check II.',annotations:[{x:1,y:4,w:32,h:90,label:'Limb leads: leftward polarity pattern',tone:'amber'}]},
    {title:'Right-axis deviation pattern',image:'assets/ecgs/left posterior fasicular block.jpeg',caption:'A negative QRS in lead I with a positive QRS in aVF places the axis in the rightward quadrant, generally beyond +90°.',features:['Lead I negative','aVF positive','Axis generally > +90°','Consider RVH, LPFB or lateral infarction'],pearl:'I negative, aVF positive = right axis.',annotations:[{x:1,y:4,w:32,h:90,label:'Limb leads: rightward polarity pattern',tone:'amber'}]},
    {title:'Extreme (“northwest”) axis pattern',image:'assets/ecgs/ventricular tachycard - monomorphic.jpeg',caption:'Predominantly negative QRS complexes in both lead I and aVF indicate the extreme axis quadrant.',features:['Lead I negative','aVF negative','Axis approximately −90° to ±180°','May support ventricular origin in a broad-complex tachycardia'],pearl:'Negative-negative = extreme quadrant.',annotations:[{x:1,y:4,w:32,h:90,label:'Both I and aVF predominantly negative',tone:'red'}]}
  ]
});


Object.assign(STUDY_TOPICS.find(t=>t.title==='Atrial and ventricular hypertrophy'), {
  summary:'Chamber enlargement is not one pattern. Compare atrial P-wave changes with ventricular voltage, axis and strain patterns.',
  points:['Inspect P waves in II and V1 for atrial enlargement','Use voltage criteria as supportive evidence, not proof','Look for associated frontal-axis shift','Check for secondary “strain” ST–T changes','Compare V1 with the lateral precordial leads'],
  examples:[
    {title:'Left ventricular hypertrophy',image:'assets/ecgs/left ventricular hypertrophy1.jpeg',caption:'High left-sided voltage may be accompanied by lateral repolarisation (“strain”) changes.',features:['Deep S waves in right precordial leads','Tall R waves in V5–V6','Possible leftward axis','Lateral ST depression/T-wave inversion may occur'],pearl:'Voltage plus a lateral strain pattern is more convincing than voltage alone.',annotations:[{x:4,y:8,w:30,h:80,label:'Right precordials: deep S waves',tone:'amber'},{x:66,y:8,w:30,h:80,label:'Lateral leads: tall R ± strain',tone:'green'}]},
    {title:'Right ventricular hypertrophy — example 1',image:'assets/ecgs/right ventricular hypertrophy.jpeg',caption:'Rightward ventricular forces can create a dominant R wave in V1 and right-axis deviation.',features:['Dominant R in V1','Right-axis deviation','Deep S waves in lateral leads','Right-precordial strain may be present'],pearl:'A tall R in V1 needs a differential; combine it with axis and clinical context.',annotations:[{x:3,y:8,w:31,h:80,label:'V1 region: dominant R wave',tone:'green'},{x:66,y:8,w:31,h:80,label:'Lateral leads: persistent S waves',tone:'amber'}]},
    {title:'Right ventricular hypertrophy — example 2',image:'assets/ecgs/right ventricular hypertrophy1.jpeg',caption:'A second RVH tracing demonstrates that the same diagnosis can vary in voltage and repolarisation appearance.',features:['Right-precordial R-wave prominence','Rightward frontal forces','Possible V1–V3 strain','Exclude RBBB and posterior infarction'],pearl:'Do not diagnose RVH from one lead in isolation.',annotations:[{x:3,y:8,w:35,h:80,label:'Right-precordial forces',tone:'green'}]},
    {title:'Right ventricular hypertrophy — example 3',image:'assets/ecgs/right ventricular hypertrophy 2.png',caption:'Another morphology of right ventricular dominance for pattern comparison.',features:['Dominant anterior rightward forces','Possible right-axis deviation','Lateral S-wave persistence','Morphology may differ with severity and cause'],pearl:'Learn the pattern across several tracings rather than memorising one image.',annotations:[{x:3,y:8,w:35,h:80,label:'Compare V1–V3 morphology',tone:'amber'}]}
  ]
});

Object.assign(STUDY_TOPICS.find(t=>t.title==='Ischaemia, injury and infarction'), {
  summary:'Localise ST–T abnormalities by contiguous lead groups, then distinguish ischaemia, acute injury, infarction and mimics.',
  points:['Inferior: II, III, aVF','Anterior/septal: V1–V4','Lateral: I, aVL, V5–V6','Look for reciprocal change in opposing leads','ST depression/T inversion may reflect subendocardial ischaemia','ECG alone cannot distinguish unstable angina from NSTEMI'],
  examples:[
    {title:'Stable angina / transient ischaemia',image:'assets/ecgs/angina pectoris.jpeg',caption:'Transient subendocardial ischaemia may produce horizontal or down-sloping ST depression during symptoms or stress.',features:['ST depression in anatomically related leads','Possible T-wave inversion','Changes may resolve when ischaemia ends','No persistent territorial ST elevation'],pearl:'ST depression describes ischaemia; biomarkers and clinical course determine the syndrome.',annotations:[{x:3,y:8,w:94,h:80,label:'Inspect ST segments for depression',tone:'amber'}]},
    {title:'NSTEMI pattern',image:'assets/ecgs/NSTEMI.jpeg',caption:'NSTEMI may show ST depression and/or T-wave inversion, but the diagnosis requires myocardial injury biomarkers.',features:['ST depression may be localised','T-wave inversion may occur','No diagnostic persistent STEMI pattern','Troponin separates NSTEMI from unstable angina'],pearl:'Do not label NSTEMI from ECG alone.',annotations:[{x:3,y:8,w:94,h:80,label:'Subendocardial ST–T abnormalities',tone:'amber'}]},
    {title:'Inferior STEMI',image:'assets/ecgs/inferior STEMI.jpeg',caption:'Acute inferior injury produces ST elevation in II, III and aVF, often with reciprocal depression in I and aVL.',features:['ST elevation: II, III, aVF','Reciprocal ST depression: I, aVL','Assess for right-ventricular involvement','Check rhythm and AV conduction'],pearl:'Inferior leads together define the territory.',annotations:[{x:1,y:54,w:32,h:38,label:'II, III, aVF: ST elevation',tone:'green'},{x:1,y:4,w:32,h:28,label:'I, aVL: reciprocal depression',tone:'red'}]},
    {title:'Anterior STEMI',image:'assets/ecgs/anterior STEMI.jpeg',caption:'Anterior injury is recognised by ST elevation across the anterior/septal precordial leads.',features:['ST elevation commonly V1–V4','May extend laterally to V5–V6, I and aVL','Reciprocal inferior depression may occur','Later Q waves may develop'],pearl:'Map the abnormal precordial leads before naming the territory.',annotations:[{x:34,y:5,w:62,h:82,label:'V1–V4: anterior ST elevation',tone:'green'}]},
    {title:'STEMI — additional morphology',image:'assets/ecgs/STEMI.jpeg',caption:'A second acute-injury tracing shows that ST elevation shape and magnitude vary between patients.',features:['Elevation in contiguous leads','Possible reciprocal depression','Interpret against the PR/TP baseline','Clinical urgency depends on the whole presentation'],pearl:'Do not require one “textbook” ST shape.',annotations:[{x:3,y:8,w:94,h:80,label:'Identify contiguous elevated leads',tone:'green'}]},
    {title:'Acute pericarditis — important mimic',image:'assets/ecgs/pericarditis.jpeg',caption:'Pericarditis classically causes widespread ST elevation with PR-segment depression rather than one coronary territory.',features:['Diffuse rather than territorial ST elevation','PR depression may be present','Usually no focal reciprocal depression except aVR/V1','Compare with STEMI distribution'],pearl:'Diffuse + PR change suggests pericarditis; territorial + reciprocal change suggests STEMI.',annotations:[{x:3,y:8,w:94,h:80,label:'Widespread ST elevation / PR changes',tone:'amber'}]}
  ]
});

Object.assign(STUDY_TOPICS.find(t=>t.title==='Electrolytes and QT'), {
  summary:'Electrolyte abnormalities evolve over time. Compare T-wave shape, conduction, QRS width and QT duration rather than relying on one isolated sign.',
  points:['Hyperkalaemia progresses from peaked T waves to conduction slowing and QRS widening','Hypokalaemia can flatten T waves and produce U waves','Hypercalcaemia shortens QT mainly by shortening ST','Hypocalcaemia prolongs QT','Long QT increases torsades risk'],
  examples:[
    {title:'Hyperkalaemia — peaked T-wave stage',image:'assets/ecgs/hyperkalemia.jpeg',caption:'Early hyperkalaemia often produces tall, narrow, symmetric (“tented”) T waves.',features:['Tall narrow symmetric T waves','Shortened repolarisation appearance early','P waves may still be present','Changes are often diffuse'],pearl:'Hyperkalaemic T waves are narrow and pointed, not simply “large.”',annotations:[{x:3,y:8,w:94,h:80,label:'Tall narrow peaked T waves',tone:'amber'}]},
    {title:'Hyperkalaemia — more advanced pattern',image:'assets/ecgs/hyperkalemia1.jpeg',caption:'As potassium rises, P waves may flatten/disappear, PR may lengthen and QRS may widen.',features:['Peaked T waves','Reduced P-wave amplitude','Conduction slowing','QRS widening in severe cases'],pearl:'Severity changes the ECG—do not expect the early pattern forever.',annotations:[{x:3,y:8,w:94,h:80,label:'Assess P waves, QRS width and T waves together',tone:'red'}]},
    {title:'Hypercalcaemia',image:'assets/ecgs/hypercalcemia.jpeg',caption:'Hypercalcaemia shortens ventricular repolarisation, chiefly by shortening the ST segment and therefore QT.',features:['Short QT interval','Short ST segment','T-wave shape may be relatively preserved','Compare QT with heart rate'],pearl:'Calcium mainly changes QT duration.',annotations:[{x:3,y:8,w:94,h:80,label:'Shortened ST/QT interval',tone:'green'}]},
    {title:'Long-QT consequence: torsades de pointes',image:'assets/ecgs/torsades de pointes.jpeg',caption:'Torsades is a polymorphic ventricular tachycardia associated with prolonged repolarisation.',features:['Polymorphic wide complexes','Amplitude appears to twist around baseline','Long QT is an important substrate','Hypokalaemia and hypomagnesaemia increase risk'],pearl:'The rhythm is the complication; inspect a preceding ECG for QT prolongation.',annotations:[{x:3,y:8,w:94,h:80,label:'Twisting polymorphic ventricular complexes',tone:'red'}]},
    {title:'Digoxin repolarisation effect',image:'assets/ecgs/T-waves-digoxin-effect.jpg',caption:'Digoxin creates a characteristic scooped ST depression that can mimic ischaemic ST–T change.',features:['Scooped down-sloping ST depression','Flattened or inverted T waves','QT may shorten','Effect does not itself prove toxicity'],pearl:'Recognise the “reverse tick” morphology.',annotations:[{x:3,y:8,w:94,h:80,label:'Scooped ST depression',tone:'amber'}]}
  ]
});

Object.assign(STUDY_TOPICS.find(t=>t.title==='Ventricular rhythms'), {
  summary:'Ventricular rhythms form a spectrum from isolated ectopy to organised wide-complex rhythms and chaotic fibrillation.',
  points:['First decide whether the event is premature or an escape rhythm','Assess QRS width and morphology','Use rate to distinguish idioventricular rhythm/AIVR from VT','Differentiate monomorphic from polymorphic VT','VF has no organised QRS complexes or effective output'],
  examples:[
    {title:'Premature ventricular complex (PVC)',image:'assets/ecgs/ECG-Premature-Ventricular-Complex-PVC-Bigeminy.jpg',caption:'A premature ventricular impulse creates an early broad QRS without a preceding sinus P wave.',features:['Premature broad QRS','No normal preceding P wave','Discordant ST–T direction','Often followed by a compensatory pause'],pearl:'Premature + broad + no preceding P wave.',annotations:[{x:3,y:8,w:94,h:80,label:'Identify the premature broad complexes',tone:'amber'}]},
    {title:'Accelerated idioventricular rhythm (AIVR)',image:'assets/ecgs/accelerated idioventricular.jpeg',caption:'A ventricular rhythm with a rate commonly around 50–110/min, often seen during reperfusion.',features:['Wide ventricular complexes','Usually regular','Rate slower than typical VT','AV dissociation or fusion beats may occur'],pearl:'A wide ventricular rhythm is not automatically VT—check the rate.',annotations:[{x:3,y:8,w:94,h:80,label:'Wide ventricular rhythm at a moderate rate',tone:'green'}]},
    {title:'Monomorphic ventricular tachycardia',image:'assets/ecgs/ventricular tachycard - monomorphic.jpeg',caption:'A rapid regular wide-complex rhythm with a consistent QRS shape.',features:['Fast regular rhythm','Wide QRS complexes','Same morphology beat to beat','AV dissociation, capture or fusion may support VT'],pearl:'Treat a regular broad-complex tachycardia as VT until proven otherwise.',annotations:[{x:3,y:8,w:94,h:80,label:'Wide regular monomorphic complexes',tone:'red'}]},
    {title:'Polymorphic ventricular tachycardia',image:'assets/ecgs/ventricular tachycard- polymorphic.png',caption:'QRS morphology and axis vary continuously during a rapid ventricular rhythm.',features:['Rapid wide-complex rhythm','Beat-to-beat morphology changes','May occur with normal or prolonged QT','Differentiate torsades by QT context and twisting pattern'],pearl:'Polymorphic describes changing morphology—not automatically torsades.',annotations:[{x:3,y:8,w:94,h:80,label:'Changing QRS morphology',tone:'red'}]},
    {title:'Torsades de pointes',image:'assets/ecgs/torsades de pointes.jpeg',caption:'A specific polymorphic VT pattern in which QRS amplitude and axis appear to twist around the baseline.',features:['Polymorphic wide complexes','Waxing and waning amplitude','Associated with prolonged QT','Electrolytes and QT-prolonging drugs are important'],pearl:'Torsades = polymorphic VT in a long-QT setting.',annotations:[{x:3,y:8,w:94,h:80,label:'Twisting around the baseline',tone:'red'}]},
    {title:'Ventricular flutter',image:'assets/ecgs/ECG-ventricular-flutter-4-4.jpg',caption:'Very rapid ventricular activity may create a near-sinusoidal waveform without distinct QRS/T separation.',features:['Very rapid regular waveform','No clear P, QRS and T separation','May deteriorate to VF','Produces severe haemodynamic compromise'],pearl:'Think of an organised bridge between VT and VF.',annotations:[{x:3,y:8,w:94,h:80,label:'Rapid near-sinusoidal ventricular activity',tone:'red'}]},
    {title:'Ventricular fibrillation',image:'assets/ecgs/ventricular fibrillation.jpeg',caption:'Chaotic ventricular electrical activity with no organised QRS complexes and no effective cardiac output.',features:['Completely disorganised waveform','No identifiable QRS complexes','Variable amplitude and frequency','Cardiac-arrest rhythm'],pearl:'No organised complexes means no effective ventricular pumping.',annotations:[{x:3,y:8,w:94,h:80,label:'Chaotic activity without organised QRS',tone:'red'}]},
    {title:'Junctional escape — comparison rhythm',image:'assets/ecgs/junctional&#x3a;escape rhythm.jpeg',caption:'A narrow junctional escape rhythm is included as a comparison so it is not confused with a wide ventricular escape rhythm.',features:['Usually narrow QRS','Absent or retrograde P waves','Slow protective escape rate','Origin is AV junction, not ventricle'],pearl:'QRS width helps localise the escape focus.',annotations:[{x:3,y:8,w:94,h:80,label:'Narrow escape complexes for comparison',tone:'green'}]}
  ]
});

Object.assign(STUDY_TOPICS.find(t=>t.title==='Digoxin effect'), {
  examples:[
    {title:'Therapeutic digoxin effect',image:'assets/ecgs/T-waves-digoxin-effect.jpg',caption:'Expected repolarisation changes include scooped ST depression and T-wave flattening/inversion.',features:['Scooped “reverse tick” ST depression','T-wave flattening or inversion','QT may shorten','AV conduction may slow'],pearl:'Effect is an ECG pattern, not a diagnosis of poisoning.',annotations:[{x:3,y:8,w:94,h:80,label:'Scooped ST segments',tone:'amber'}]},
    {title:'Possible digoxin toxicity pattern',image:'assets/ecgs/digitalis drug toxicity&#x3a;digoxin.jpeg',caption:'Digoxin toxicity can cause many atrial, junctional, ventricular and AV-conduction abnormalities; no single rhythm is unique.',features:['Assess rhythm and AV conduction','Ectopy or tachyarrhythmia may occur','Clinical level and symptoms matter','Electrolyte disturbance can modify risk'],pearl:'There is no one pathognomonic toxicity rhythm.',annotations:[{x:3,y:8,w:94,h:80,label:'Review rhythm and conduction—not only ST shape',tone:'red'}]}
  ]
});

Object.assign(STUDY_TOPICS.find(t=>t.title==='Bundle and fascicular blocks'), {
  examples:[
    {title:'Right bundle branch block — example 1',image:'assets/ecgs/RBBB.jpeg',caption:'Delayed right ventricular activation gives a terminal R′ in V1 and broad terminal S waves laterally.',features:['Wide QRS when complete','rSR′ or terminal R′ in V1–V2','Broad terminal S in I and V6','Secondary ST–T discordance'],pearl:'Look at V1, then confirm the broad lateral S wave.',annotations:[{x:2,y:8,w:31,h:82,label:'V1–V2: terminal R′',tone:'green'},{x:65,y:8,w:33,h:82,label:'I/V6: broad terminal S',tone:'amber'}]},
    {title:'Right bundle branch block — example 2',image:'assets/ecgs/RBBB2.jpeg',caption:'A second RBBB example demonstrates normal variation in the exact rSR′ morphology.',features:['Terminal right-precordial positivity','Broad lateral S wave','QRS prolongation','Repolarisation usually discordant in V1–V3'],pearl:'Recognise the activation sequence, not one exact “rabbit ear” shape.',annotations:[{x:2,y:8,w:31,h:82,label:'Right-precordial terminal forces',tone:'green'}]},
    {title:'Left bundle branch block — example 1',image:'assets/ecgs/LBBB.jpeg',caption:'Delayed left ventricular activation produces broad lateral R waves and a predominantly negative V1.',features:['Wide QRS','Broad/notched R in I, aVL, V5–V6','Deep S or QS in V1','Secondary discordant ST–T changes'],pearl:'LBBB changes both depolarisation and repolarisation.',annotations:[{x:2,y:8,w:31,h:82,label:'V1: deep negative complex',tone:'amber'},{x:65,y:8,w:33,h:82,label:'Lateral broad/notched R',tone:'green'}]},
    {title:'Left bundle branch block — example 2',image:'assets/ecgs/LBBB.webp',caption:'A second LBBB morphology reinforces the broad, slurred lateral activation pattern.',features:['Broad QRS','Absent normal septal q waves laterally','Broad monophasic/notched lateral R','ST–T discordance'],pearl:'Compare V1 with V6 as a pair.',annotations:[{x:2,y:8,w:31,h:82,label:'V1 morphology',tone:'amber'},{x:65,y:8,w:33,h:82,label:'V6 morphology',tone:'green'}]},
    {title:'Left posterior fascicular block',image:'assets/ecgs/left posterior fasicular block.jpeg',caption:'A fascicular pattern associated with right-axis deviation after other causes are excluded.',features:['Right-axis deviation','rS in I/aVL','qR in III/aVF','QRS may be only mildly prolonged'],pearl:'Axis alone is not enough—exclude RVH and infarction.',annotations:[{x:1,y:4,w:32,h:90,label:'Compare limb-lead polarity for right axis',tone:'amber'}]}
  ]
});
